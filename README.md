This repository includes the materials used in evaluating the AutRQ framework. It presents requirements corrected and conceptual models (gold model) extracted from user stories and use cases.
